...
CHESS_CURRICULUM = {
    'pawn': [
        {'topic': 'Шахматная доска и фигуры', 'desc': 'Знакомство с доской, полями и названиями всех фигур'},
        {'topic': 'Как ходят фигуры', 'desc': 'Правила ходов пешки, ладьи, слона, коня, ферзя и короля'},
        {'topic': 'Ценность фигур', 'desc': 'Относительная ценность фигур и простые размены'},
        {'topic': 'Шах, мат и пат', 'desc': 'Понятия шаха, мата и пата, простейшие маты в 1 ход'},
        {'topic': 'Рокировка и спецходы', 'desc': 'Рокировка, взятие на проходе, превращение пешки'},
        {'topic': 'Первые партии', 'desc': 'Как начинать партию: центр, развитие фигур'},
        {'topic': 'Тактика: вилка', 'desc': 'Двойной удар конём и пешкой'},
        {'topic': 'Тактика: связка', 'desc': 'Связка слоном и ладьёй'},
        {'topic': 'Простые маты', 'desc': 'Мат ферзём и ладьёй, линейный мат'},
        {'topic': 'Пешечные гонки', 'desc': 'Правило квадрата, проходная пешка'},
        {'topic': 'Записываем ходы', 'desc': 'Шахматная нотация: как записывать партию'},
        {'topic': 'Первый турнир', 'desc': 'Правила поведения и основы спортивных шахмат'},
    ],
    'knight': [
        {'topic': 'Основы дебюта', 'desc': 'Принципы начала партии: центр, развитие, безопасность короля'},
        {'topic': 'Тактика: двойной удар', 'desc': 'Вилки конём, пешкой и другими фигурами'},
        {'topic': 'Тактика: открытое нападение', 'desc': 'Открытый шах, открытое нападение, рентген'},
        {'topic': 'Простые комбинации', 'desc': 'Комбинации из 2 ходов, жертвы для мата'},
        {'topic': 'Мат в 2 хода', 'desc': 'Решение матовых задач в 2 хода'},
        {'topic': 'Основы эндшпиля', 'desc': 'Мат королём и ферзём, королём и ладьёй'},
        {'topic': 'Пешечные окончания', 'desc': 'Оппозиция, отдалённая проходная'},
        {'topic': 'Итальянская партия', 'desc': 'Первый дебют: 1.e4 e5 2.Кf3 Кc6 3.Сc4'},
        {'topic': 'Ловушки в дебюте', 'desc': 'Типичные дебютные ловушки и как их избежать'},
        {'topic': 'Атака на f7/f2', 'desc': 'Самые уязвимые пункты в начале партии'},
        {'topic': 'Размен и инициатива', 'desc': 'Когда менять фигуры, а когда сохранять'},
        {'topic': 'Практика и анализ', 'desc': 'Анализ собственных партий, работа над ошибками'},
    ],
    'bishop': [
        {'topic': 'Дебютные принципы', 'desc': 'Углублённое изучение дебютных принципов'},
        {'topic': 'Сицилианская защита', 'desc': 'Основные варианты сицилианской защиты'},
        {'topic': 'Углубленная тактика', 'desc': 'Отвлечение, завлечение, перекрытие'},
        {'topic': 'Комбинационное зрение', 'desc': 'Развитие расчёта вариантов, задачи в 3 хода'},
        {'topic': 'Пешечная структура', 'desc': 'Типы пешечных структур и планы игры'},
        {'topic': 'Атака на короля', 'desc': 'Принципы атаки, типичные жертвы на h7'},
        {'topic': 'Защита и контратака', 'desc': 'Методы защиты, профилактика'},
        ...
        {'topic': 'Типичные планы', 'desc': 'Планы в закрытых и открытых позициях'},
        {'topic': 'Турнирная практика', 'desc': 'Применение всех концепций в реальных партиях'},
    ],
    'rook': [
        ...
        {'topic': 'Анализ партий ГМ', 'desc': 'Разбор партий гроссмейстеров с комментариями'},
        {'topic': 'Психология шахмат', 'desc': 'Управление временем, подготовка к турнирам'},
        {'topic': 'Стратегический план', 'desc': 'Долгосрочное стратегическое планирование'},
    ],
    'queen': [
        {'topic': 'Подготовка к соперникам', 'desc': 'Методы подготовки к конкретным противникам'},
        {'topic': 'Новинки в дебюте', 'desc': 'Поиск и подготовка дебютных новинок'},
        {'topic': 'Каталонское начало', 'desc': 'Глубокое изучение каталонского начала'},
        {'topic': 'Английское начало', 'desc': 'Фланговые дебюты и нестандартные идеи'},
        {'topic': 'Профилактика Нимцовича', 'desc': 'Профилактическое мышление в миттельшпиле'},
        {'topic': 'Типичные жертвы', 'desc': 'Жертва на d5, e6, h7 — когда и зачем'},
        {'topic': 'Техника защиты', 'desc': 'Защита худших позиций, крепости, контригра'},
        {'topic': 'Комплексные окончания', 'desc': 'Разноцветные слоны, ладья и слон vs ладья и конь'},
        {'topic': 'Расчёт вариантов', 'desc': 'Тренировка глубокого и точного расчёта'},
        {'topic': 'Анализ партий чемпионов', 'desc': 'Изучение творчества Каспарова, Карлсена'},
        {'topic': 'Турнирная стратегия', 'desc': 'Контроль времени, управление турнирным графиком'},
        {'topic': 'Путь к мастерству', 'desc': 'Индивидуальный план достижения мастерского уровня'},
    ],
}

# backward-compat aliases
CHESS_CURRICULUM['beginner'] = CHESS_CURRICULUM['pawn']
CHESS_CURRICULUM['intermediate'] = CHESS_CURRICULUM['bishop']
CHESS_CURRICULUM['advanced'] = CHESS_CURRICULUM['rook']
...
def generate_task_content(topic_name, task_title, task_type, level, week_description=''):
    ...
    level_labels = {
        'pawn': 'начинающего (уровень Пешка)',
        'knight': 'начинающего-среднего (уровень Конь)',
        'bishop': 'среднего (уровень Слон)',
        'rook': 'продвинутого (уровень Ладья)',
        'queen': 'экспертного (уровень Ферзь)',
        'beginner': 'начинающего',
        'intermediate': 'среднего',
        'advanced': 'продвинутого',
    }
    level_label = level_labels.get(level, level_labels['pawn'])
